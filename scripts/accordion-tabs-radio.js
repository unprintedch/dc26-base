const ACCORDION_SELECTOR = '.wp-block-accordion.is-style-dc26-tabs-vertical, .wp-block-accordion.is-style-dc26-tabs-horizontal';
...
const updateMinHeight = (accordion) => {
    if (accordion.classList.contains('is-style-dc26-tabs-horizontal')) {
