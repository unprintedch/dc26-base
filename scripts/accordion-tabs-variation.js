...
domReady(() => {
    ...
    registerBlockVariation('core/accordion', {
        name: 'dc26-tabs-horizontal',
        title: __('Tabs (horizontal)', 'dc26-oav'),
        icon: 'index-card',
        scope: ['inserter'],
        attributes: {
            className: 'is-style-dc26-tabs-horizontal',
            autoclose: true,
            showIcon: false,
        },
        innerBlocks: [
            [
                ...
                { openByDefault: true },
                [
                    ['core/accordion-heading', { title: __('Onglet 1', 'dc26-oav') }],
                    ['core/accordion-panel', {}, [['core/paragraph', { placeholder: __('Contenu...', 'dc26-oav') }]]],
                ],
            ],
            [
                'core/accordion-item',
                {},
                [
                    ['core/accordion-heading', { title: __('Onglet 2', 'dc26-oav') }],
                    ['core/accordion-panel', {}, [['core/paragraph', { placeholder: __('Contenu...', 'dc26-oav') }]]],
                ],
            ],
        ],
